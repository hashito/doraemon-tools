  ...
  var app = new Vue({
    ...
    methods: {
      ...
      popUpTweetWindow: function () {
        var text=`私はドラえもんのポケットから「${this.tool}」を引き当てました！`
        var tg_url =`https://doraemon-tools.hashito.biz/`
        const url = `https://twitter.com/intent/tweet?hashtags=doraemontools&text=${encodeURI(text)}&url=${encodeURI(tg_url)}` 
